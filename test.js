...
// const crypter = new Cryptr();

// console.log(crypter.encrypt('a'));

const youtubeSearch = require('scrape-youtube').default;
youtubeSearch.search('빅뱅노래 모음', {type: 'playlist'}).then(r => {
    ...
    console.log(r.playlists[0].videos[0]);
}).catch(err => {
    console.log(err, 'No Search Results found');
})